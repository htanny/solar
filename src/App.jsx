...
export default function App(){
  ...
  useEffect(function(){tourRef.current.active=touring;if(touring){tourRef.current.idx=0;tourRef.current.timer=0;tourRef.current.trans=false;}},[touring]);
  ...
  useEffect(function(){
    ...
    function frame(ts2){
      ...
      if(tourRef.current.trans){/* camera managed by tour pan */}else if(hasTarget||fc==="sun"){cam.fx=tfx;cam.fy=tfy;cam.fz=tfz;}else if(fc==="all"){cam.fx*=0.92;cam.fy*=0.92;cam.fz*=0.92;}
