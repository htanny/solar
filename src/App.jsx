...
export default function App(){
  ...
  return(
    <div style={{width:"100%",height:"100vh",background:"rgba(3,3,10,1)",position:"relative",overflow:"hidden"}}>
      ...
      {cleanView===0&&<div style={{position:"absolute",bottom:10,left:"50%",transform:"translateX(-50%)",color:"rgba(255,255,255,0.2)",fontSize:9,fontFamily:"system-ui,sans-serif",pointerEvents:"none",zIndex:10,textAlign:"center"}}>クリックで選択　ドラッグ：回転　ピンチ：ズーム　パネルはドラッグ移動可能<br/><span style={{fontSize:8,opacity:0.6}}>v2.1.4 2026-04-18</span></div>}
