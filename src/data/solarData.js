...
export var QUIZ_DATA=[
  ...
  /* === 受験対策 (lv:4) 10問 — 月の満ち欠け・金星の見え方(中学受験・中3理科頻出) === */
  {lv:4,q:"夕方、南の空に見える月の形は？",a:["右半分が光る上弦の月","満月","左半分が光る下弦の月","新月"],c:0,hint:"上弦の月は18時ごろ南中する",qe:"What moon phase appears in the southern sky at dusk?",ae:["First quarter (right half lit)","Full moon","Last quarter (left half lit)","New moon"],hinte:"First quarter souths around 6 PM"},
  {lv:4,q:"満月が南中する時刻は？",a:["真夜中0時ごろ","夕方18時ごろ","明け方6時ごろ","正午12時ごろ"],c:0,hint:"満月は日没に昇り、明け方に沈む",qe:"When does the full moon reach its highest point?",ae:["Around midnight","Around 6 PM","Around 6 AM","Around noon"],hinte:"Full moon rises at sunset, sets at dawn"},
  {lv:4,q:"明け方、東の低い空に見える細い月は？",a:["左側が光る有明月","右側が光る三日月","上弦の月","満月"],c:0,hint:"新月の直前の月。左側(太陽側)が光る",qe:"What thin moon appears low in the east at dawn?",ae:["Waning crescent (left side lit)","Waxing crescent (right side lit)","First quarter","Full moon"],hinte:"Just before new moon; lit on the Sun's side"},
  {lv:4,q:"日食が起こるのはどの月相のとき？",a:["新月","満月","上弦の月","下弦の月"],c:0,hint:"太陽-月-地球の順に一直線に並ぶ",qe:"At which phase do solar eclipses occur?",ae:["New moon","Full moon","First quarter","Last quarter"],hinte:"Sun–Moon–Earth align in that order"},
  {lv:4,q:"月食が起こるのはどの月相のとき？",a:["満月","新月","上弦の月","三日月"],c:0,hint:"太陽-地球-月の順に一直線に並ぶ",qe:"At which phase do lunar eclipses occur?",ae:["Full moon","New moon","First quarter","Waxing crescent"],hinte:"Sun–Earth–Moon align in that order"},
  {lv:4,q:"月の出の時刻は毎日どうなる？",a:["約50分ずつ遅くなる","約50分ずつ早くなる","変わらない","約2時間ずつ遅くなる"],c:0,hint:"月が公転で1日約12°東へ動くため",qe:"How does moonrise time change each day?",ae:["~50 min later each day","~50 min earlier each day","Stays the same","~2 hours later each day"],hinte:"The Moon moves ~12° east per day in its orbit"},
  {lv:4,q:"金星が真夜中に見えない理由は？",a:["地球より内側を公転しているから","小さすぎるから","自転が遅いから","真夜中は大気が厚くなるから"],c:0,hint:"内惑星は太陽から大きく離れて見えない",qe:"Why is Venus never visible at midnight?",ae:["It orbits inside Earth's orbit","It is too small","It rotates too slowly","The atmosphere thickens at night"],hinte:"Inner planets never appear far from the Sun"},
  {lv:4,q:"夕方、西の空に見える金星を何と呼ぶ？",a:["宵の明星","明けの明星","天狼星","北極星"],c:0,hint:"「宵」=日が暮れてまもない時間帯",qe:"What is Venus in the western evening sky called?",ae:["Evening star","Morning star","Sirius","Polaris"],hinte:"Visible shortly after sunset"},
  {lv:4,q:"内合(地球に最接近)へ近づく金星はどう見える？",a:["大きく、細い三日月形になる","小さく、丸くなる","大きさも形も変わらない","小さく、細くなる"],c:0,hint:"近いほど大きく、太陽との角度で欠けて見える",qe:"How does Venus appear as it nears inferior conjunction?",ae:["Larger and thinner crescent","Smaller and rounder","No change in size or shape","Smaller and thinner"],hinte:"Closer = larger; geometry makes it a crescent"},
  {lv:4,q:"宵の明星として金星が最も高く見えるのはいつ？",a:["東方最大離角のとき","内合のとき","外合のとき","西方最大離角のとき"],c:0,hint:"太陽から最も離れて見える位置(東側)",qe:"When is Venus highest as the evening star?",ae:["Greatest eastern elongation","Inferior conjunction","Superior conjunction","Greatest western elongation"],hinte:"Farthest apparent angle east of the Sun"},
];
