var PANEL_INIT={showEvents:false,showDate:false,searchOpen:false,dispColl:false,exoOpen:false,nightSkyOpen:false,bookOpen:false,moonCal:false,orbElemOpen:false,importMode:false,compareTable:false,satOpen:false,tourPick:false};
/* Mutually-exclusive panel set: only one open at a time (used on phone) */
var EXCLUSIVE_KEYS=["showEvents","searchOpen","exoOpen","nightSkyOpen","bookOpen","moonCal","orbElemOpen","compareTable","satOpen","tourPick"];
